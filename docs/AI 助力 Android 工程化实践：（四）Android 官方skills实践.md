...
<div style="margin: 16px 0; padding: 16px; border: 1px solid #E5E7EB; border-radius: 8px; background: #F9FAFB;">
  <div style="display: flex; flex-wrap: wrap; gap: 8px; align-items: center;">
    <span style="padding: 8px 12px; border-radius: 6px; background: #FFFFFF; border: 1px solid #E5E7EB; font-weight: 600;">开发者任务</span>
    <span style="color: #9CA3AF;">→</span>
    <span style="padding: 8px 12px; border-radius: 6px; background: #FFFFFF; border: 1px solid #E5E7EB; font-weight: 600;">Codex / Agent</span>
    <span style="color: #9CA3AF;">→</span>
    <span style="padding: 8px 12px; border-radius: 6px; background: #EFF6FF; border: 1px solid #DBEAFE; color: #1D4ED8; font-weight: 600;">读取 SKILL.md</span>
    <span style="color: #9CA3AF;">→</span>
    <span style="padding: 8px 12px; border-radius: 6px; background: #ECFDF5; border: 1px solid #D1FAE5; color: #047857; font-weight: 600;">分析 / 修改 / 验证</span>
    <span style="color: #9CA3AF;">→</span>
    <span style="padding: 8px 12px; border-radius: 6px; background: #FFFBEB; border: 1px solid #FEF3C7; color: #B45309; font-weight: 600;">输出可审查结果</span>
  </div>
</div>
...
<div style="display: flex; flex-wrap: wrap; gap: 12px; margin: 16px 0;">
  <div style="flex: 1; min-width: 240px; padding: 16px; border: 1px solid #FECACA; border-radius: 8px; background: #FEF2F2;">
    <div style="font-size: 14px; color: #991B1B; font-weight: 700;">普通 Prompt</div>
    <div style="margin-top: 8px; color: #374151; line-height: 1.7;">
      临时描述需求，质量依赖提示词完整度。适合简单任务，但复杂迁移容易遗漏步骤和边界。
    </div>
  </div>
  <div style="flex: 1; min-width: 240px; padding: 16px; border: 1px solid #BFDBFE; border-radius: 8px; background: #EFF6FF;">
    <div style="font-size: 14px; color: #1D4ED8; font-weight: 700;">Skill</div>
    <div style="margin-top: 8px; color: #374151; line-height: 1.7;">
...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 12px; margin: 16px 0;">
  <div style="padding: 14px; border: 1px solid #E5E7EB; border-radius: 8px; background: #FFFFFF;">
    <div style="font-weight: 700; color: #111827;">agp-9-upgrade</div>
    <div style="margin-top: 6px; color: #2563EB; font-size: 13px;">构建升级</div>
    <div style="margin-top: 8px; color: #4B5563;">AGP 9 / Gradle / Kotlin / KSP</div>
  </div>
  <div style="padding: 14px; border: 1px solid #E5E7EB; border-radius: 8px; background: #FFFFFF;">
    <div style="font-weight: 700; color: #111827;">migrate-xml-views-to-jetpack-compose</div>
    <div style="margin-top: 6px; color: #059669; font-size: 13px;">UI 迁移</div>
    <div style="margin-top: 8px; color: #4B5563;">XML → Compose</div>
  </div>
  <div style="padding: 14px; border: 1px solid #E5E7EB; border-radius: 8px; background: #FFFFFF;">
    <div style="font-weight: 700; color: #111827;">navigation-3</div>
    <div style="margin-top: 6px; color: #7C3AED; font-size: 13px;">导航架构</div>
    <div style="margin-top: 8px; color: #4B5563;">Jetpack Navigation 3</div>
  </div>
  <div style="padding: 14px; border: 1px solid #E5E7EB; border-radius: 8px; background: #FFFFFF;">
    <div style="font-weight: 700; color: #111827;">r8-analyzer</div>
    <div style="margin-top: 6px; color: #D97706; font-size: 13px;">包体积优化</div>
    <div style="margin-top: 8px; color: #4B5563;">R8 / ProGuard keep 规则</div>
  </div>
  <div style="padding: 14px; border: 1px solid #E5E7EB; border-radius: 8px; background: #FFFFFF;">
    <div style="font-weight: 700; color: #111827;">play-billing-library-version-upgrade</div>
    <div style="margin-top: 6px; color: #BE123C; font-size: 13px;">支付升级</div>
    <div style="margin-top: 8px; color: #4B5563;">Google Play Billing Library</div>
  </div>
  <div style="padding: 14px; border: 1px solid #E5E7EB; border-radius: 8px; background: #FFFFFF;">
    <div style="font-weight: 700; color: #111827;">edge-to-edge</div>
    <div style="margin-top: 6px; color: #0891B2; font-size: 13px;">系统适配</div>
    <div style="margin-top: 8px; color: #4B5563;">Android 15 edge-to-edge</div>
  </div>
</div>
...
<div style="margin: 16px 0; padding: 16px; border: 1px solid #E5E7EB; border-radius: 8px; background: #F9FAFB;">
  <div style="display: flex; flex-wrap: wrap; gap: 8px; align-items: center;">
    <span style="padding: 8px 12px; border-radius: 6px; background: #FFFFFF; border: 1px solid #E5E7EB; font-weight: 600;">下载 Android CLI</span>
    <span style="color: #9CA3AF;">→</span>
    <span style="padding: 8px 12px; border-radius: 6px; background: #EFF6FF; border: 1px solid #DBEAFE; color: #1D4ED8; font-weight: 600;">android update</span>
    <span style="color: #9CA3AF;">→</span>
    <span style="padding: 8px 12px; border-radius: 6px; background: #EFF6FF; border: 1px solid #DBEAFE; color: #1D4ED8; font-weight: 600;">android init</span>
    <span style="color: #9CA3AF;">→</span>
    <span style="padding: 8px 12px; border-radius: 6px; background: #ECFDF5; border: 1px solid #D1FAE5; color: #047857; font-weight: 600;">android skills list</span>
    <span style="color: #9CA3AF;">→</span>
    <span style="padding: 8px 12px; border-radius: 6px; background: #ECFDF5; border: 1px solid #D1FAE5; color: #047857; font-weight: 600;">android skills add --all</span>
    <span style="color: #9CA3AF;">→</span>
    <span style="padding: 8px 12px; border-radius: 6px; background: #FFFBEB; border: 1px solid #FEF3C7; color: #B45309; font-weight: 600;">重启 Codex CLI</span>
    <span style="color: #9CA3AF;">→</span>
    <span style="padding: 8px 12px; border-radius: 6px; background: #FFFFFF; border: 1px solid #E5E7EB; font-weight: 600;">点名 Skill</span>
  </div>
</div>
